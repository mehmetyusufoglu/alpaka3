...
if(alpaka_ENABLE_ROCBLAS)
    ...
    if(rocblas_FOUND)
        ...
        if(_rocblas_loc AND EXISTS "${_rocblas_loc}")
            ...
            message(WARNING "rocBLAS enabled but library file unresolved -> using generic GEMM kernels")
        endif()
    else()
        message(STATUS "rocBLAS enabled but not found -> using generic GEMM kernels")
    endif()
else()
...
if(alpaka_ENABLE_MIOPEN)
    ...
    if(_miopen_variant_upper OR _miopen_variant_lower)
        ...
        if(_miopen_loc AND EXISTS "${_miopen_loc}")
            ...
            message(WARNING "MIOpen enabled but library file unresolved -> using generic convolution kernels")
        endif()
    else()
        message(STATUS "MIOpen enabled but not found -> using generic convolution kernels")
    endif()
else()
...
if(ALPAKA_VENDOR_RPATH AND NOT alpaka_DISABLE_VENDOR_RPATH)
    ...
    if(TARGET alpaka_target_hip)
        set_target_properties(alpaka_target_hip PROPERTIES BUILD_RPATH "${ALPAKA_VENDOR_RPATH}" INSTALL_RPATH "${ALPAKA_VENDOR_RPATH}")
    endif()
endif()
