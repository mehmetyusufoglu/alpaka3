...
option(alpaka_EXEC_TbbBlocks "Enable/Disable TBB blocks executor in examples/benchmarks and tests" ${alpaka_DEP_TBB})
if(alpaka_EXEC_TbbBlocks AND NOT alpaka_DEP_TBB)
    message(FATAL_ERROR "alpaka_EXEC_TbbBlocks requires alpaka_DEP_TBB=ON")
endif()
if(NOT alpaka_EXEC_TbbBlocks)
