...
tensor::Tensor<T, Rank, Device> binaryLazy(Exec const& exec, Device const& device, Queue& queue, tensor::Tensor<T, Rank, Device>& a, tensor::Tensor<T, Rank, Device>& b, Functor f, const char* name="binary") {
...
template<typename T, std::size_t Rank, typename Exec, typename Device, typename Queue, typename Functor>
tensor::Tensor<T, Rank, Device> unaryLazy(Exec const& exec, Device const& device, Queue& queue, tensor::Tensor<T, Rank, Device>& in, Functor f, const char* name="unary") {
...
tensor::Tensor<T, Rank, Device> addLazy(Exec const& exec, Device const& device, Queue& queue, tensor::Tensor<T, Rank, Device>& a, tensor::Tensor<T, Rank, Device>& b) {
    return binaryLazy<T, Rank>(exec, device, queue, a, b, AddOp{}, "add_lazy");
}

template<typename T, std::size_t Rank, typename Exec, typename Device, typename Queue>
tensor::Tensor<T, Rank, Device> mulLazy(Exec const& exec, Device const& device, Queue& queue, tensor::Tensor<T, Rank, Device>& a, tensor::Tensor<T, Rank, Device>& b) {
...
tensor::Tensor<T, Rank, Device> mul_scalarLazy(Exec const& exec, Device const& device, Queue& queue, tensor::Tensor<T, Rank, Device>& in, S scalar) {
    return unaryLazy<T, Rank>(exec, device, queue, in, MulScalarOp<S>{scalar}, "mul_scalar_lazy");
}

template<typename T, std::size_t Rank, typename Exec, typename Device, typename Queue>
tensor::Tensor<T, Rank, Device> reluLazy(Exec const& exec, Device const& device, Queue& queue, tensor::Tensor<T, Rank, Device>& in) {
...
template<typename T, std::size_t Rank, typename Exec, typename Device, typename Queue, typename S>
TensorView<T, Rank, Device> mul_scalar(TensorView<T, Rank, Device> view, Exec const& exec, Device const& device, Queue& queue, S scalar) {
...
template<typename T, std::size_t Rank, typename Exec, typename Device, typename Queue>
TensorView<T, Rank, Device> add(TensorView<T, Rank, Device> view, Exec const& exec, Device const& device, Queue& queue, tensor::Tensor<T, Rank, Device>& other) {
    auto& tensor = view.getTensor();
...
template<typename T, std::size_t Rank, typename Exec, typename Device, typename Queue>
tensor::Tensor<T, Rank, Device> relu(TensorView<T, Rank, Device> view, Exec const& exec, Device const& device, Queue& queue) {
    auto& tensor = view.getTensor();
...
template<typename T, std::size_t Rank, typename Exec, typename Device, typename Queue, typename S>
auto operator|(TensorView<T, Rank, Device> view, std::tuple<Exec, Device&, Queue&, S>) -> TensorView<T, Rank, Device> {
